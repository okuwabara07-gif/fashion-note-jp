...
const SITE_NAME = 'ファッションノート';
const TOPIC = 'ファッション・コーディネート・服・ブランド';
const CRITERIA = 'デザイン・品質・コスパ・サイズ感・口コミ';
...
async function generateArticle(keyword) {
  ...
  const a8_michinailLink = `[→ ミチネイルはこちら](https://px.a8.net/svt/ejp?a8mat=4AZR8U+D8W8C2+34VM+25EKCY)`;
